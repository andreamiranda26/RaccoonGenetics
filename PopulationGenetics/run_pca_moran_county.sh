#!/bin/bash
#SBATCH --job-name=PCA_Moran
#SBATCH --output=logs/PCA_Moran-%j.out
#SBATCH --error=logs/PCA_Moran-%j.err
...
cd ${ROOT_DIR}/scripts/PopulationGenetics

Rscript pca_moran_county.R